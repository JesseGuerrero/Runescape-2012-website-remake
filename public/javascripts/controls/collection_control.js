...
export var CollectionControl = L.Control.extend({    
    ...
    onAdd: function (map) {
        ...
        // Area control
        this._createControl('<img src="/assets/images/worldmap/area-icon.png" alt="Area" title="Area" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._areas, "areas_converter", e.target);
        });        

        // Poly Area control
        this._createControl('<img src="/assets/images/worldmap/polyarea-icon.png" alt="Poly Area" title="Poly Area" height="30" width="30">', container, function(e) {
            this._toggleCollectionMode(this._polyArea, "polyarea_converter", e.target);
        });

        // Path control
        this._createControl('<img src="/assets/images/worldmap/path-icon.png" alt="Path" title="Path" height="30" width="30">', container, function(e) {
