...
}
{
        ...
        a.extend(c.prototype, {
            ...
            _optionDatepicker: function (b, f, j) {
                ...
                if (l) {
                    ...
                    var n = this._getDateDatepicker(b, true), k = this._getMinMaxDate(l, "min"),
            ...
            _checkOffset: function (b, f, j) {
                var l = b.dpDiv.outerWidth(), o = b.dpDiv.outerHeight(),
                    n = b.input ? b.input.outerWidth() : 0, k = b.input ? b.input.outerHeight() : 0,
            ...
            _generateHTML: function (b) {
                ...
                var j = this._get(b, "isRTL"), l = this._get(b, "showButtonPanel"),
                    o = this._get(b, "hideIfNoPrevNext"), n = this._get(b, "navigationAsDateFormat"),
                    k = this._getNumberOfMonths(b), m = this._get(b, "showCurrentAtPos"),
                    p = this._get(b, "stepMonths"), q = k[0] != 1 || k[1] != 1,
                ...
                var y = this._get(b, "dayNamesMin"), H = this._get(b, "monthNames"),
                    C = this._get(b, "monthNamesShort"), z = this._get(b, "beforeShowDay"),
                        ...
                        for (var R = 0; R < G; R++) {
                            ...
                            for (B = 0; B < 7; B++) {
                                var M = z ? z.apply(b.input ? b.input[0] : null, [A]) : [true, ""],
                                    K = A.getMonth() != m, O = K && !N || !M[0] || r && A < r || u && A > u;
            ...
            _generateMonthYearHeader: function (b, f, j, l, o, n, k, m) {
                var p = this._get(b, "changeMonth"), q = this._get(b, "changeYear"),
                    s = this._get(b, "showMonthAfterYear"), r = '<div class="ui-datepicker-title">', u = "";
    ...
    (function (a) {
        ...
        a.fn.position = function (g) {
            ...
            g = a.extend({}, g);
            var i = a(g.of), b = i[0], f = (g.collision || "flip").split(" "),
                j = g.offset ? g.offset.split(" ") : [0, 0], l, o, n;
            if (b.nodeType === 9) {
                l = i.width();
                o = i.height();
                n = {top: 0, left: 0}
    ...
    (function (a) {
        a.widget("ui.slider", a.ui.mouse, {
            ...
            _refreshValue: function () {
                var d =
                        this.options.range, c = this.options, e = this, h = !this._animateOff ? c.animate : false, g,
                    i = {}, b, f, j, l;
...
/*
     FILE ARCHIVED ON 05:21:53 Jul 09, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 01:33:17 Mar 18, 2023.
...
playback timings (ms):
  ...
  esindex: 0.009
  LoadShardBlock: 272.787 (6)
  PetaboxLoader3.datanode: 244.923 (7)
  load_resource: 120.511
  PetaboxLoader3.resolve: 47.661
*/
