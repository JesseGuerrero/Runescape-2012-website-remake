...
!function (e) {
    ...
    function r(e, t) {
        for (var n = 0; n < t.length; n++) {
            var r = t[n];
            r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(e, (i = r.key, s = void 0, s = function (e, t) {
    ...
    if (n.d(t, "a", (function () {
        ...
        var f = function (e) {
            ...
            var t, n, o, a, l, f = (t = p, n = c(), function () {
                var e, o = h(t);
                if (n) {
            ...
            return o = p, a && r(o.prototype, a), l && r(o, l), Object.defineProperty(o, "prototype", {writable: !1}), o
        }(a(XMLHttpRequest));
    ...
    function p(e, t, n, o, r) {
        ...
        }, i.open(e, t, !0), o) for (var s in o) o.hasOwnProperty(s) && i.setRequestHeader(s, o[s]);
    ...
    function y(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "src", n = "_wm_".concat(t);
    ...
    function a(e, t, n, r) {
        return r = r || {}, Object(o.a)("POST", "/__wb/web-archive/", (function (e) {
            401 === e.status ? r.userNotLoggedIn && r.userNotLoggedIn(e) : e.status >= 400 ? r.failure && r.failure(e) : r.success && r.success(e)
        }), {"Content-Type": "application/json"}, s.stringify({url: e, snapshot: t, tags: n || []})), !1
    }
    ...
    var l = function () {
        function e(t, n, r) {
            ...
            !function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.el = t, this.url = n, this.timestamp = r, t.onclick = this.save.bind(this), document.addEventListener("DOMContentLoaded", (function () {
        ...
        return t = e, (n = [{
            ...
            key: "enableSaveSnapshot", value: function () {
                ...
                e ? (this.show("wm-save-snapshot-open"), this.hide("wm-sign-in")) : (this.hide(["wm-save-snapshot-open", "wm-save-snapshot-in-progress"]), this.show("wm-sign-in"))
            }
        }, {
    ...
    var o;
    n.r(t);
    var r, i = {createElementNS: document.createElementNS};
    var s = !0;
    ...
    function m(e, t, n) {
        ...
        h.length > 0 ? (s = 0, h.map((function (e) {
            e.match("^https?://") && (s++, Object(l.a)("HEAD", e, (function (e) {
                if (200 == e.status) {
                    ...
                    if (null == t) console.log("%s: no Memento-Datetime", u); else {
                        var n = document.createElement("span"), a = function (e, t) {
                            ...
                            s > 1 ? (f.push(s + " years"), r = !0) : 1 == s && (f.push(s + " year"), r = !0);
                            a > 1 ? (f.push(a + " months"), r = !0) : 1 == a && (f.push(a + " month"), r = !0);
                            ...
                            return {delta: i, text: o + f.join(" "), highlight: r}
                        }(t, i), l = a.highlight ? "color:red;" : "";
                        n.innerHTML = " " + a.text, n.title = t, n.setAttribute("style", l);
                        var c = e.getResponseHeader("Content-Type"),
                            u = e.responseURL.replace(window.location.origin, ""), h = document.createElement("a");
                        h.innerHTML = u.split("/").splice(3).join("/"), h._wm_href = u, h.title = c, h.onmouseover = g, h.onmouseout = w;
    ...
    function g(e) {
        ...
        if (t.length > 0) for (var n = 0; n < t.length; n++) y(t[n]).classList.add("wb-highlight")
    }

    function w(e) {
        var t = v(window, e.target.href);
        if (t.length > 0) for (var n = 0; n < t.length; n++) y(t[n]).classList.remove("wb-highlight")
    }
    ...
    function O(e, t, n, o) {
        C(o || document, t, (function (t) {
            for (var o, r = t.target || t.srcElement; r && !(o = k(r, e));) r = r.parentElement;
            o && n.call(r, t)
        }))
    }
    ...
    var H, E, j = function () {
        function e(t, n) {
            ...
            }), this.sc), O("wb-autocomplete-suggestion", "mouseover", (function (e) {
            ...
            }), this.sc), O("wb-autocomplete-suggestion", "mousedown", (function (e) {
    ...
    function F(e) {
        H.classList.contains("wm-closed") ? (e && E.classList.add("notice-only"), H.classList.replace("wm-closed", "wm-open"), E.style.display = "block", m(q, B, I)) : (H.classList.replace("wm-open", "wm-closed"), E.style.display = "none", E.classList.remove("notice-only"))
    }
    ...
    window.__wm = {
        init: function (e) {
            !function () {
                ...
                return 0 == e.indexOf(o) && (e = e.substring(o.length).replace(/\/?[0-9]+\//, "")), i.createElementNS.call(this, e, t)
            }
        }, wombat: function (e, t, n, o, i, a) {
            var l = "".concat(n).concat(o, "/"), c = l.replace(/^https?:/, ""), u = new URL(e), h = {
                url: e,
                timestamp: t,
                prefix: l,
                coll: o,
                ...
                wombat_host: u.host,
                wombat_opts: {no_rewrite_prefixes: ["/__wb/", i, "".concat(n).concat(i.substring(1)), "/web/", l, c, "http://analytics.archive.org/", "https://analytics.archive.org/", "//analytics.archive.org/"]}
            };
            if ("undefined" != typeof _WBWombat) {
                ...
                }, (r = _WBWombat(window, h)).actual = !0, window._wb_wombat = r.wombatInit(), window._wb_wombat.actual = !0, r
            }
        }, rw: function (e) {
            s = e
            ...
            var v;
            B = p || "/static/", q = s;
            var y, g, w, b = "/" + (r || "web") + "/", S = c.c(q), _ = S.getUTCFullYear(), T = S.getUTCMonth() + 1,
                M = S.getUTCDate(), k = -1, C = -1, x = I("wm-ipp-base");
            if (x.attachShadow) {
                var O = x.attachShadow({mode: "closed"});
                for (D = O; x.children.length > 0;) O.appendChild(x.children[0]);
                if (d) for (var j = 0; j < d.length; j++) {
                    var W = P.createElement("link");
                    W.setAttribute("rel", "stylesheet"), W.setAttribute("type", "text/css"), W.setAttribute("href", d[j]), O.appendChild(W)
                }
            }

            function Y() {
                var e = I("donato").offsetHeight + (I("wm-ipp-inside").offsetHeight - I("wm-capinfo").offsetHeight);
                console.debug("adjustHeight: baseHeight=%s", e + "px"), x.style.height = e + "px"
            }

            window.top == window.self && (x.style.display = "block");
            var J = !1, G = !0, z = null === (v = I("donato-if")) || void 0 === v ? void 0 : v.contentWindow,
                V = I("donato");
            if (console.debug("$donato = %o", V), V) if (window.top != window.self) V.style.display = "none", console.debug("hid $donato as window.top != window.self"); else {
                var K = I("donato-base");
                window.addEventListener("message", (function (e) {
                    if (e.source === z) {
                        ...
                        if (console.log("got message %o", t), "set height" == t.event) {
                            ...
                            if (!G) return;
                            if (t.value, J) return;
                            V.style.height = o + "px", K.style.height = n + "px", Y()
                        } else if ("open modal" == t.event) K.style.height = "", document.body.classList.add("wm-modal"), window.scrollTo(0, 0), J = !0; else if ("close modal" == t.event) V.style.marginBottom = "0px", document.body.classList.remove("wm-modal"), J = !1; else if ("hide banner" == t.event) {
                            V.style.height = 0, V.style.visibility = "hidden";
                            var r = new U(U.now() + 24 * t.value * 3600 * 1e3);
                            document.cookie = "donation=x; domain=archive.org; path=/; expires=" + r.toUTCString(), G = !1, J = !1, 0, Y()
                        }
                    }
                }), !1), console.debug("installed message listener to #donato-base: %o", K)
            }
            I("wm-tb-close").addEventListener("click", (function (e) {
                I("wm-ipp-inside").style.display = "none", e.preventDefault(), Y()
            }));
            ...
            function Z(e) {
                ...
                if (t !== y) {
                    var n = I("wm-ipp"), o = I("displayYearEl"), r = I("displayMonthEl"), i = I("displayDayEl");
                    t ? n.className = "hi" : (n.className = "", o.innerHTML = _, r.innerHTML = c.b(T - 1), i.innerHTML = h(M, 2)), g.style.display = t ? "inline" : "none", w.style.display = t ? "inline" : "none", y = t
                }
            }

            H = I("wm-expand"), E = I("wm-capinfo"), I("wm-graph-anchor")._no_rewrite = !0, (g = P.createElement("div")).className = "yt", g.style.display = "none", g.style.width = n + "px", g.style.height = t + "px", (w = P.createElement("div")).className = "mt", w.style.display = "none", w.style.width = o + "px", w.style.height = t + "px", Q.appendChild(g), Q.appendChild(w);
            var ee = I("wm-sparkline-canvas");
            Q.onmouseenter = Z, Q.onmouseleave = Z, Q.onmousemove = function (t) {
                var r, s, l = Q, u = function (e) {
                    ...
                    f = (r = l, s = P.documentElement, ("undefied" != typeof r.getBoundingClientRect ? r.getBoundingClientRect() : {
                        top: 0,
                        left: 0
                    }).left + (window.pageXOffset || s.scrollLeft) - (s.clientLeft || 0)),
                    p = Math.min(Math.max(0, u - f), e), d = p % n, m = Math.floor(p / n),
                    v = Math.min(11, Math.floor(d / o)), y = 12 * m + v, S = d % 2 == 1 ? 15 : 1,
                    _ = h(m + a) + h(v + 1, 2) + h(S, 2) + "000000";
                I("displayYearEl").innerHTML = m + a, I("displayMonthEl").innerHTML = c.b(v);
                var T = b + _ + "/" + i;
                if (I("wm-graph-anchor").href = T, k != m) {
                    var M = m * n;
                    g.style.left = M + "px", k = m
                }
                if (C != y) {
                    var x = m + y * o + 1;
                    w.style.left = x + "px", C = y
                }
            };
            ...
            if (te.getContext && te.getContext("2d")) {
                ...
                Object(l.a)("GET", ne, (function (n) {
                    if (200 == n.status) {
                        ...
                        !function (e) {
                            for (var t = I("wm-nav-captures"), n = 0, o = e.years, r = e.first_ts, s = e.last_ts, a = 0; a < o.length; a++) for (var l = o[a][1], u = 0; u < l.length; u++) n += l[u];
                            var h = '<a class="t" href="' + b + "*/" + i + '" title="See a list of every capture for this URL">' + (("" + n).replace(/\B(?=(\d{3})+$)/g, ",") + " ") + (n > 1 ? "captures" : "capture") + "</a>",
                                f = c.a(r, "%d %b %Y");
                            s != r && (f += " - " + c.a(s, "%d %b %Y")), h += '<div class="r" title="Timespan for captures of this URL">' + f + "</div>", t.innerHTML = h
                        }(o), function (e, t, n, o, r, i, s) {
                            var a = o.getContext("2d");
                            if (a) {
                                a.fillStyle = "#FFF";
                                var l = (new u).getUTCFullYear(), c = t / (l - r + 1), h = f(e.years), p = h[0],
                                    d = n / h[1];
                                if (i >= r) {
                                    var m = M(i);
                                    a.fillStyle = "#FFFFA5", a.fillRect(m, 0, c, n)
                                }
                                for (var v = r; v <= l; v++) {
                                    m = M(v);
                                ...
                                for (var y = (c - 1) / 12, g = 0; g < p.length; g++) {
                                    ...
                                    for (var w = p[g][1], b = M(v) + 1, S = 0; S < 12; S++) {
                                        ...
                                        if (_ > 0) {
                                            var T = Math.ceil(_ * d);
                                            a.fillStyle = v == i && S == s ? "#EC008C" : "#000", a.fillRect(Math.round(b), Math.ceil(n - T), Math.ceil(y), Math.round(T))
                                        }
                                        b += y
                                    }
                                }
                ...
                var oe = new Image;
                oe.src = "/__wb/sparkline?url=" + encodeURIComponent(i) + "&width=" + e + "&height=" + t + "&selected_year=" + _ + "&selected_month=" + T + (r && "&collection=" + r || ""), oe.alt = "sparkline", oe.width = e, oe.height = t, oe.id = "sparklineImgId", oe.border = "0", ee.parentNode.replaceChild(oe, ee)
            }
            ...
            I("wm-share-facebook").onclick = function (e) {
                ...
                delay: 400, source: function (e, t) {
                    Object(l.a)("GET", "/__wb/search/host?q=" + encodeURIComponent(e), (function (n) {
                        if (void 0 !== (n = A.parse(n.response)).hosts && n.hosts.length > 0) {
                            var o = re(n.hosts);
                            t(o)
                        } else void 0 !== n.isUrl && !0 === n.isUrl && void 0 === n.excluded ? t([e]) : Object(l.a)("GET", "/__wb/search/anchor?q=" + encodeURIComponent(e), (function (e) {
                ...
                $(e, t, (function (e, t) {
                    e ? (I("wm-screenshot").title = "screen shot (delta: " + t + "s)", X("wm-screenshot", !0)) : X("wm-screenshot", !1)
                }))
            }(i, q), m && function (e, t) {
                !function (e, t, n) {
                    ...
                    if (e.status < 300) {
                        ...
                        X("wm-video", !0), I("wm-video").href = t.url, I("wm-video").title = "Video: " + t.title
                    } else X("wm-video", !1)
                }))
            }(i, q), I("wm-capinfo-notice") && F(!0), new R.a(I("wm-save-snapshot-open"), i, q)
        }, ex: function (e) {
            e.stopPropagation(), F(!1)
        }, ajax: l.a, sp: function () {
            return B
        }
    }
}]);
